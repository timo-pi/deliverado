...
test_request6 = Request.create!(order_number: "TZ8390052",
                            name: "Claudia Schöneberg",
                            delivery_address: "Georg-Krammel-Str. 10",
                            city: "85290 Geisenfeld",
                            size: "M",
                            message: "Be careful please",
                            # time_from: DateTime.new(2019,2,5,18,0,0),
                            # time_to: DateTime.new(2019,2,5,20,0,0),
                            phone_number: "+49 17190653371",
                            store: test_store1,
                            time_from: "14:00",
                            time_to: "20:00",
                            price: 500)

test_request7 = Request.create!(order_number: "BF9087443",
                            name: "Simon Schmidt",
                            delivery_address: "Salvator Str. 2",
                            city: "85290 Geisenfeld",
                            size: "L",
                            message: "Please be careful",
                            # time_from: DateTime.new(2019,2,5,18,0,0),
                            # time_to: DateTime.new(2019,2,5,20,0,0),
                            phone_number: "+49 8452905633",
                            store: test_store1,
                            time_from: "17:30",
                            time_to: "20:00",
                            price: 500)

test_request8 = Request.create!(order_number: "RF8920577",
                            name: "Michael Grüber",
                            delivery_address: "Semptstr. 13",
                            city: "85290 Geisenfeld",
                            size: "S",
                            message: "It's a Watch Apple",
                            # time_from: DateTime.new(2019,2,5,18,0,0),
                            # time_to: DateTime.new(2019,2,5,20,0,0),
                            phone_number: "+49 1509234611",
                            store: test_store1,
                            time_from: "16:00",
                            time_to: "21:30",
                            price: 500)

test_request9 = Request.create!(order_number: "SE5002943",
                            name: "Maria Betz",
                            delivery_address: "Pindharter Str. 29",
                            city: "85290 Geisenfeld",
                            size: "M",
                            message: "It's a laptop",
                            # time_from: DateTime.new(2019,2,5,18,0,0),
                            # time_to: DateTime.new(2019,2,5,20,0,0),
                            phone_number: "+49 85424432",
                            store: test_store1,
                            time_from: "18:00",
                            time_to: "20:00",
                            price: 500)
